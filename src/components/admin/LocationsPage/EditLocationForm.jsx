...
export default function EditLocationForm({ countryNames,locationData}) {
...
router.back()
  ...
  const formik = useFormik({
    initialValues: {
      ...
      image: null,
      imagePreview: locationData?.imageUrl,
    },
    ...
    onSubmit: async(values) => {
      try {
        ...
        const response=await adminAxiosInstance.put("/location/update-location/"+locationData._id,formData)
